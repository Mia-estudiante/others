...
GALLERY_TEST_PATH = os.path.join(ROOT, 'DukeMTMC-reID/query') #gallery 이미지 폴더 -> csv 내 fn_name과 연결할 것(GALLERY_TEST_PATH와 csv 내 fn_name과 하나하나 join)
IMG_GALLERY_TEST_PATH = os.path.join('/static', 'DukeMTMC-reID/gallery')
...
CSV_GALLERY_TEST_PATH = os.path.join(ROOT, 'models_static/DukeMTMC-reID/DukeMTMC-reID/results_csv/duke')
...
REPOSITORY = os.path.join(ROOT, 'views/html/models_static/DukeMTMC-reID') #html 파일이 저장될 곳 -> csv명과 동일하게 파일 제작
