...
#%%
ROOT = os.getcwd()
GALLERY_TEST_PATH = os.path.join(ROOT, 'public/market1501') #gallery 이미지 폴더 -> csv 내 fn_name과 연결할 것(GALLERY_TEST_PATH와 csv 내 fn_name과 하나하나 join)
IMG_GALLERY_TEST_PATH = os.path.join(GALLERY_TEST_PATH, 'gallery')
CSV_GALLERY_TEST_PATH = os.path.join(ROOT, 'public/models_static/reid_lup_duke_backaug075/reid_lup_duke_backaug075/results_csv/market1501')
QUERY_PATH = os.path.join(GALLERY_TEST_PATH, 'query') #query 이미지 폴더 -> csv명과 연결할 것(QUERY_PATH와 csv명과 join)
REPOSITORY = os.path.join(ROOT, 'public/views/html/models_static/reid_lup_duke_backaug075') #html 파일이 저장될 곳 -> csv명과 동일하게 파일 제작
